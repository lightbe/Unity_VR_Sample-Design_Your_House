...
{
    public GameObject flockingObjectPrefab;
    ...
    private const int flockCount = 20;

    private GameObject[] _flock = new GameObject[flockCount];
    private GameObject[] _flock_last_frame = new GameObject[flockCount];
    ...
    void Start()
    {
        ...
        for (int i = 0; i < _flock.Length; i++)
        {
            ...
            _flock[i] = Instantiate(flockingObjectPrefab);
